...
- $\text{volemia}_{homens} = \text{altura}^3 \times 0.367 \times \text{peso} \times 0.32 + 0.604$
- $\text{volemia}_{mulheres} = \text{altura}^3 \times 0.356 \times \text{peso} \times 0.33 + 0.183$
...
|                            4                             |   1 (4.3%)    |
|                            9                             |   1 (4.3%)    |
|   __Perda de hemoglobina 24h, Média (Desvio Padrão)__    |  1,502 (370)  |
|      __Perda sanguínea 24h, Média (Desvio Padrão)__      | 5,163 (1,817) |
|   __Perda de hemoglobina 48h, Média (Desvio Padrão)__    |  1,241 (297)  |
|      __Perda sanguínea 48h, Média (Desvio Padrão)__      | 4,278 (1,402) |
...
Após 24h os participantes apresentaram perda de hemoglobina em torno de 1,502 em média, e após 48h esta perda se reduziu para 1,241.
A perda de sangue média um dia após a cirurgia foi de 5,163, reduzida para 4,278 no segundo dia.
